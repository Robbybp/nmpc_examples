...
\section{August 4, 2022}

After some consternation, have updated tests to use new
data structure and functions.
Now I should update the code in pipeline-examples.
{\bf Done.} That was pretty easy.
Now I should update the code in \texttt{gas\_distribution}

\medskip

Have tested the code in the \texttt{pyomo-update} branch of
\texttt{gas\_distribution}.
At this point the code is almost ready. I just need to make sure
things are (a) reasonable and (b) tested.
\begin{itemize}
  \item Change \texttt{get\_time\_indexed\_cuid} to
    \texttt{get\_indexed\_cuid}
  \item Completely remove old interval data structure
\end{itemize}
...
\end{itemize}
Then, after this, I can finish the IntervalData class.
